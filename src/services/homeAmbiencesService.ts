...
</dy-write>Agora vou atualizar o Settings.tsx para adicionar o botão "Novo Ambiente" e a lógica de criação.

<dyad-write path="src/pages/app/Settings.tsx" description="Adicionando botão Novo Ambiente e lógica de criação">
          ...
          <form onSubmit={handleSaveAmbience} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setAmbienceFormData({ ...ambience, category_slug: e.target.value })}
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) => setAmbience(0] => setAmbienceFormData({ ...ambienceFormData, active: checked })}
                disabled={savingAmbience}
              />
            ...
            <div className="flex gap-2 justify-end pt-4">
              ...
              <Button type="submit" disabled={savingAmbience}>
                {savingAmbience ? (
                  ...
                  <>
                    <Save size={16} continua className="mr-2" />
                    Salvar
                  </>
                )}
              </Button>
