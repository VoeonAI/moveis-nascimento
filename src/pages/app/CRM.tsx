                        ...
                        <div key={event.id} className="flex gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                              {format(new Date(event.created_at), "dd/MM/yyyy 'às' HH:mmVou implementar o patch mínimo para corrigir o badge de "Novo Interesse" no card do CRM, baseando-se na última atividade da timeline.

<dyad-write path="src/pages/app/CRM.tsx" description="Fixed 'Novo Interesse' badge to use last timeline event instead of unread_interest_count">
import React, { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { crmService, Opportunity, TimelineEvent } from '@/services/crmService';
import { ordersService } from '@/services/ordersService';
